...
- **GPU:** NVIDIA con almeno 12GB VRAM (consigliato 16GB+)

- **CUDA:** 12.6+

- **RAM:** 32GB consigliati

- **Spazio disco:** ~150GB per modelli + spazio per output
...
### 6. Scarica i modelli pesanti



> 📦 I modelli non sono inclusi nel repository per via delle dimensioni. Scaricali separatamente:

modello di base flux 2 kevin 9b (circa 46 GB) + Ltx 2 ( circa 90 gb),tot : circa 136 gb



**Link disponibili a breve** — verranno pubblicati qui sotto:



- `MegaLora/` — LoRA per Flux 2 *(https://huggingface.co/Asprho/megalora/tree/main)*

(circa 10 gb)

- `modelLTX2/` — Modello LTX-2 *(https://huggingface.co/Asprho/megalora/tree/main)*

(circa 5 gb)



Estrai i file `.rar` e assicurati che la struttura del progetto sia:
...
- Se la GPU non ha abbastanza VRAM, l'app utilizzerà la CPU (molto più lenta)

- I modelli quantizzati riducono il consumo di VRAM mantenendo buona qualità
...
Uso personale e creativo. I modelli AI utilizzati sono soggetti alle rispettive licenze su Hugging Face.
...
</div>; Editing EditImage/readme at main · asprho-arkimete/EditImage 
